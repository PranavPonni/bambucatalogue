...
(() => {
  ...
  const card = p => `<article class="product-card" data-id="${p.id}">
    ...
    <div class="price-block"><p class="price-label">EST. PRICE</p><p class="price">${materialRange(p)}</p><p class="price-note">Final quote on enquiry</p></div>
